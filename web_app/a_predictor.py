...
class A_Predictor: #custom model 1 - #Adele
    ...
    def __init__(self):
        ...
        self.lite_model = tf.interpreter = tf.lite.Interpreter(model_path=r"C:\Users\muhammaddaniyal2\Desktop\keyword_spotting\models\a_model.tflite")
        self.model = tf.keras.models.load_model(r'C:\Users\muhammaddaniyal2\Desktop\keyword_spotting\models\a_model.keras')
